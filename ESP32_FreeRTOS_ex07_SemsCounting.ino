...
// Task: Copy contents of parameters, print it to serial
void myTask(void *parameter) {
  // Copy message struct from the parameter to a local variable
  ...
  // And that the critical section had been run
...
void setup() {
  ...
  // Create a message to use as argument, common to all tasks
